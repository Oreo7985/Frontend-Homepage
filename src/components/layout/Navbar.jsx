import { HomeIcon, UserIcon, Briefcase, InstagramIcon, SunIcon, MoonIcon, Menu, X } from 'lucide-react';
...
export default function Navbar({ className, isOpen, onToggle, isDark, onToggleDark }) {
            ...
            `}>
                <div className="h-full flex flex-col">
                    ...
                    <div className="flex-1 flex items-end p-4">
                        <div className="px-3 py-6 w-full flex flex-col items-center gap-4">
                            <button
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 italic text-center">
                                &copy; {new Date().getFullYear()} Luhang Fang<br />
                                All rights reserved
                            </p>
                        </div>
                    </div>
