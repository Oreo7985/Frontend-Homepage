...
export default function Home({ className }) {
  ...
  const socialLinks = [
    ...
    { icon: <Mail className="w-5 h-5" />, href: "mailto:luhang.fang@gmail.com", label: "Email" },
  ];
        ...
        >
          ...
          >
            <div className="w-40 h-40 sm:w-44 sm:h-44 md:w-48 md:h-48 xl:w-64 xl:h-64 relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-teal-400 rounded-full animate-pulse" />
              <motion.div
            ...
            <div className="absolute -z-10 inset-0 blur-3xl opacity-20 bg-gradient-to-r from-blue-500 to-teal-400 rounded-full" />
          </motion.div>
          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                className="px-6 py-3 border-2 border-gray-300 dark:border-gray-700
                           text-gray-600 dark:text-gray-300 rounded-xl font-medium
